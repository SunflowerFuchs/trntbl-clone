...
<body>
    ...
    <script src="{{ asset('js/cookies.js', true) }}?cbr={{ File::lastModified( public_path() . '/js/cookies.js' )  }}"></script>
    <script src="{{ asset('js/consent.js', true) }}?cbr={{ File::lastModified( public_path() . '/js/consent.js' )  }}"></script>
